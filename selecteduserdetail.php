...
?>
	<div class="container">
        <h2 class="text-center pt-4" style="color:white;">Transact</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
            ...
            <select name="to" class=" form-control  col-6 "required>
                ...
                <label style="color:white;">Enter the Amount:</label>
                <input type="number"class="form-control col-6" name="amount" required>   
             
                <br><br>
                    <div class="text-center" >
                <button class="btn btn-light btn-lg" name="submit" type="submit" id="myBtn">Transfer</button>
                </div>
